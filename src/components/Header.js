    ...
    return `
        <header class="flex justify-between items-center mb-6">
            <div class="flex items-center space-x-8">
                <div class="flex items-center justify-center w-8 h-8 bg-gray-700/50 rounded-md"><i data-lucide="film" class="w-5 h-5 text-gray-400"></i></div>
                <nav class="hidden md:flex items-center space-x-6 text-gray-400" id="main-nav">
                    ...
                    <a href="#" class="nav-link-active" data-page="cinema">Cinema</a>
                    <a href="#" class="hover:text-white transition-colors pb-1" data-page="collection" data-user-id="1">My Collection</a>
                </nav>
            </div>
