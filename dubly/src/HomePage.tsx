...
import filmedLogo from "@/assets/filmed.png"; // <-- 1. Importing your logo

// FeatureCard component (no changes)
...
export default function HomePage() {
  return (
    <div className="w-full">
      <section className="h-[calc(90vh)] flex flex-col items-center justify-center text-center relative overflow-hidden px-4">
        ...
        {/* --- 2. YOUR LOGO ADDED HERE --- */}
        <img 
          src={filmedLogo} 
          alt="Filmit Logo" 
          className="w-48 md:w-64 mb-8 fade-in" 
          style={{ animationDelay: '0.2s' }} 
        />
        
        <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold tracking-tighter mb-4 fade-in" style={{ animationDelay: '0.4s' }}>
          Unleash Your Inner Filmmaker
        </h1>
        <p className="max-w-2xl text-md sm:text-lg md:text-xl text-muted-foreground mb-8 fade-in" style={{ animationDelay: '0.6s' }}>
